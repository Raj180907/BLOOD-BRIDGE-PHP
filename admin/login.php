...
<body background="admin_image\glossy1.jpg">
      ...
      <div class="row justify-content-center">
          <div class="col-lg-6">
              <h1 class="mt-4 mb-3" style="color:#D2F015 ;">
                BloodBridge (Blood Bank & Donation) <br></h1>

                 <h2> ADMIN CONTROL <br></h2>
                
            </div>
      </div>
      <div class="card" style="height:250px; background-image:url('admin_image/glossy2.jpg');">
          <div class="card-body">
