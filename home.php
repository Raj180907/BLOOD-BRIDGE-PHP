...
<head>
    ...
    <meta name="author" content="">
     <title>Blood Bridge - Blood Donation Management</title>
  ...
  <div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item">
       ...
       <div class="carousel-item">
        <img src="image\db1.jpg" alt="image\db1.jpg" width="100%" height="500">
      </div>
      <div class="carousel-item">
        <img src="image\db2.jpg" alt="image\db2.jpg" width="100%" height="500">
      </div>
      <div class="carousel-item">
        <img src="image\anis.jpg" alt="image\anis.jpg" width="100%" height="500">
      </div>
...
<br>
        <h1 style="text-align:center;font-size:45px;">Welcome to  BLOOD-BRIDGE (BloodBank & Donor Management System)</h1>
<br>
        <div class="row">
